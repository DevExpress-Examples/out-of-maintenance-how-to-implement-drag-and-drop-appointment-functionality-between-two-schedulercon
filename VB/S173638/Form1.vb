    ...
    Partial Public Class Form1
        ...
        Private Sub InitAppointments(ByVal storage As SchedulerStorage)
            For i As Integer = 0 To storage.Resources.Count - 1
                ...
                Dim appointment1 As Appointment = storage.CreateAppointment(AppointmentType.Normal, Date.Today.AddHours(i + 10), Date.Today.AddHours(i + 11), subj & "birthday")
                ...
                Dim appointment2 As Appointment = storage.CreateAppointment(AppointmentType.Normal, Date.Today.AddHours(i + 13), Date.Today.AddHours(i + 14), subj & "meeting")
                ...
                Dim appointment3 As Appointment = storage.CreateAppointment(AppointmentType.Normal, Date.Today.AddHours(i + 15), Date.Today.AddHours(i + 16), subj & "phone call")
